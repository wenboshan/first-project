...
<head>
	...
	<link rel="stylesheet" href="${path}/resources/js/layui/css/index.css" media="all" />
</head>
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="${path}/resources/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
						<dl class="layui-nav-child">
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="${path}/resources/images/face.jpg" class="userAvatar"></a>
				<p>你好！<span class="userName">文泊山</span>, 欢迎登录</p>
			</div>
			<!-- 搜索 -->
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="${path}/page/backstage/main"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p><span>copyright @2018 文泊山</span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="${path}/resources/js/layui/js/index.js"></script>
	<script type="text/javascript" src="${path}/resources/js/layui/js/cache.js"></script>
</body>