...
layui.use(['form','element','layer','jquery'],function(){
    ...
    if(window.sessionStorage.getItem("systemParameter")){
        ...
        $.ajax({
            url : getContextPath()+"/resources/json/systemParameter.json",
            type : "get",
            dataType : "json",
    ...
    //最新文章列表
    $.get(getContextPath()+"/resources/json/newsList.json",function(data){
        var hotNewsHtml = '';
        for(var i=0;i<5;i++){
            hotNewsHtml += '<tr>'
    ...
    //用户数量
    $.get(getContextPath()+"/resources/json/userList.json",function(data){
